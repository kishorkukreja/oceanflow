...
// Use in-memory storage for reliable demo functionality
// To use database: export const storage = process.env.DATABASE_URL ? new DbStorage(process.env.DATABASE_URL) : new MemStorage();
